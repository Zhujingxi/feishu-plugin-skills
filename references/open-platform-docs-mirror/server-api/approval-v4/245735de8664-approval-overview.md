...
Source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/approval-overview
Markdown source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/approval-overview.md
...
**注意事项**：审批域下以tenant_access_token访问的接口默认拥有租户下的所有数据权限，应用审核时需要注意管控，对于有个人只操作用户自身范围可见数据的诉求，可以开通审批支持user_access_token的权限点，使用其相应的接口。
