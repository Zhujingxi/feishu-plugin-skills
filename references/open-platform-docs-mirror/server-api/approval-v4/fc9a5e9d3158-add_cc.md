...
Source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/add_cc
Markdown source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/add_cc.md
...
基本 | &nbsp;
---|---
HTTP URL | https://open.feishu.cn/open-apis/approval/v4/instances/add_cc
HTTP Method | POST
...
名称 | 类型 | 必填 | 描述
---|---|---|---
instance_code | string | 是 | 审批实例 Code，可通过任务列表接口获取<br>**示例值**："81D31358-93AF-92D6-7425-01A5D67C4E71"
cc_user_ids | string\[\] | 是 | 抄送人的用户 ID 列表，cc_user_ids 的 ID 类型需与 user_id_type 的取值保持一致<br>**示例值**：["ou_123456abc123"]<br>**数据校验规则**：<br>- 长度范围：`0` ～ `20`
comment | string | 否 | 抄送留言，不要超过500字<br>**示例值**："同意"
