...
Source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/initiated
Markdown source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/initiated.md
...
基本 | &nbsp;
---|---
HTTP URL | https://open.feishu.cn/open-apis/approval/v4/instances/initiated
HTTP Method | GET
...
名称 | 类型 | 必填 | 描述
---|---|---|---
page_size | int | 否 | 分页大小，默认100，控制在1～100之间<br>**示例值**：10
...
definition_code | string | 否 | 审批定义 Code，与返回值的definition_code对应，与其他接口中approval_code为同一概念，可使用返回值中内容（即从返回内容中获取到，用于做过滤）<br>**示例值**：7C468A54-8745-2245-9675-08B7C63E7A85
...
400 | 1395001 | There have been some errors. Please try again later | 服务出现错误，若为临时异常可稍后重试，若仍报错请根据响应具体 message 排查
