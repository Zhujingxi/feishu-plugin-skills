...
Source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/task/forward
Markdown source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/task/forward.md
...
基本 | &nbsp;
---|---
HTTP URL | https://open.feishu.cn/open-apis/approval/v4/tasks/forward
HTTP Method | POST
...
名称 | 类型 | 必填 | 描述
---|---|---|---
instance_code | string | 是 | 审批实例 Code，可通过查询审批列表接口获取<br>**示例值**："81D31358-93AF-92D6-7425-01A5D67C4E71"
task_id | string | 是 | 审批任务 ID，可通过查询审批列表接口获取<br>**示例值**："123456789"
transfer_user_id | string | 是 | 被转交人的用户 ID，与user_id_type类型一致<br>**示例值**："ou_abacc112aa"
comment | string | 否 | 审批意见，不超过500个字符<br>**示例值**："转交给产品专员处理"
...
400 | 1390010 | task not found | 找不到审批任务 ID，检查传入的审批任务 ID 是否正确。你可调用[获取单个审批实例详情](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/detail)，从返回结果的 task_list 中获取所需的 id。
