...
Source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/spark-v1/app-storage/download
Markdown source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/spark-v1/app-storage/download.md
...
Range | string | 否 | 在 HTTP 请求头中，通过指定 Range 来下载文件的部分内容，单位是字节（byte）。该参数的格式为 Range: bytes=start-end，示例值为 Range: bytes=0-1024，表示下载第 0 个字节到第 1024 个字节之间的数据。<br>**示例值**："Range: bytes=0-1024"
