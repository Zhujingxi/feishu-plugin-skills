...
Source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/cost_center/query_multi_timeline
Markdown source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/cost_center/query_multi_timeline.md
...
名称 | 类型 | 必填 | 描述
---|---|---|---
cost_center_ids | string\[\] | 是 | 成本中心 ID 列表，详细信息可通过[【搜索成本中心信息】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/cost_center/search)接口查询获得<br>**示例值**：["7140964208476371111"]<br>**数据校验规则**：<br>- 长度范围：`1` ～ `10`
effective_date_start | string | 否 | 生效日期开始(包含)<br>- 若不传入 effective_date_start 和 effective_date_end，默认返回当前生效版本。<br>- 支持单独传入：仅传 effective_date_start 时，返回该日期及之后生效的版本。<br>- 与 effective_date_end 同时传入时，返回两者交集范围内生效的版本<br>**示例值**："2024-01-01"<br>**数据校验规则**：<br>- 长度范围：`10` ～ `10` 字符<br>- 正则校验：`^((([0-9]{3}[1-9]|[0-9]{2}[1-9][0-9]{1}|[0-9]{1}[1-9][0-9]{2}|[1-9][0-9]{3})-(((0[13578]|1[02])-(0[1-9]|[12][0-9]|3[01]))|((0[469]|11)-(0[1-9]|[12][0-9]|30))|(02-(0[1-9]|[1][0-9]|2[0-8]))))|((([0-9]{2})(0[48]|[2468][048]|[13579][26])|((0[48]|[2468][048]|[3579][26])00))-02-29))$`
effective_date_end | string | 否 | 生效日期结束(包含)<br>- 若不传入 effective_date_start 和 effective_date_end，默认返回当前生效版本。<br>- 支持单独传入：仅传 effective_date_end 时，返回该日期及之前生效的版本。<br>- 与 effective_date_start 同时传入时，返回两者交集范围内生效的版本。<br>**示例值**："2024-12-31"<br>**数据校验规则**：<br>- 长度范围：`10` ～ `10` 字符<br>- 正则校验：`^((([0-9]{3}[1-9]|[0-9]{2}[1-9][0-9]{1}|[0-9]{1}[1-9][0-9]{2}|[1-9][0-9]{3})-(((0[13578]|1[02])-(0[1-9]|[12][0-9]|3[01]))|((0[469]|11)-(0[1-9]|[12][0-9]|30))|(02-(0[1-9]|[1][0-9]|2[0-8]))))|((([0-9]{2})(0[48]|[2468][048]|[13579][26])|((0[48]|[2468][048]|[3579][26])00))-02-29))$`
fields | string\[\] | 否 | 返回数据的字段列表，可选<br>- name：成本中心名称<br>- code：编码<br>- active：当前实体是否启用<br>- parent_cost_center_id： 上级成本中心ID<br>- managers：成本中心负责人ID 列表<br>- description：成本中心描述<br>- effective_date：版本生效日期<br>- expiration_date：版本失效日期<br>**示例值**：["name"]<br>**数据校验规则**：<br>- 长度范围：`0` ～ `100`
...
managers | string\[\] | 成本中心负责人ID 列表，详细信息可通过[【搜索员工信息】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/search)接口查询获得
