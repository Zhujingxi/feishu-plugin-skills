...
Source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/spark-v1/overview
Markdown source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/spark-v1/overview.md
...
| table/table_name | 数据表。应用中创建的数据表，用于基于结构化的业务数据。table_name 是数据表的唯一标示，同一应用下，table_name 是唯一的。 | ![](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/de878ef98b5a3067e192717c76b20a71_7DFfOVeyn1.png?height=927&lazyload=true&width=1920) |
| column/columns   | 数据表中的列                                                                 | ![](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/388865a2724cdda044d50442758234e9_AbXnMIotJ8.png?height=935&lazyload=true&width=1920) |
...
![](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/3de2bc154b5545eb4d2985ed8f99b89a_RTf47EkcO3.png?height=932&lazyload=true&width=1918)
...
![](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/ea40c8ab1347d3fedd10f7803ddd76f9_kSt1dzJj4k.png?height=934&lazyload=true&width=1920)
...
>
   ![](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/fcfa6efe0be27509860837064d76d329_srKgg6oarU.gif?height=1052&lazyload=true&width=1916)

####    1.2.4    方式四：也可以使用提供的辅助工具快速获取：<https://get-uat.apaas-apps.com:10444/>

辅助工具源码：<https://cnb.cool/codingtheworld_galaxy/get-feishu-uat>
![](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/f82263bf52239665a5f0485bf2aca903_Kjc71QXagL.gif?height=1052&lazyload=true&width=1916)
