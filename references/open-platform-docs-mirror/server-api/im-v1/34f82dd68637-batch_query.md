...
Source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message-reaction/batch_query
Markdown source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message-reaction/batch_query.md
...
page_size_per_message | int | 否 | 每个消息最多返回多少个表情<br>**默认值：**10<br>**示例值**：10<br>**数据校验规则**：<br>- 取值范围：`1` ～ `10`
...
operator_type | string | 操作人身份，用户或应用<br>**可选值有**：<br>- app：应用<br>- user：用户
...
message_id | string | 消息id
fail_reason | string | 获取表情失败的原因<br>**可选值有**：<br>- invalid：无效的消息ID<br>- invalid_page_token：该消息对应的page_token无效<br>- no_permission：操作者对该消息无权限
