...
Source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-form-field/patch
Markdown source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-form-field/patch.md
...
segment_type | string | 是 | 元素类型<br>**示例值**："text"<br>**可选值有**：<br>- text：纯文本<br>- url：链接<br>**数据校验规则**：<br>- 长度范围：`1` ～ `100` 字符
...
segment_type | string | 元素类型<br>**可选值有**：<br>- text：纯文本<br>- url：链接
text | string | 文本值
link | string | 链接
