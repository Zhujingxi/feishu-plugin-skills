...
Source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/bot-v4/bot/search
Markdown source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/bot-v4/bot/search.md
...
基本 | &nbsp;
---|---
HTTP URL | https://open.feishu.cn/open-apis/bot/v4/bot/search
HTTP Method | POST
接口频率限制 | [100 次/分钟](https://open.feishu.cn/document/ukTMukTMukTM/uUzN04SN3QjL1cDN)
支持的应用类型 | Custom App
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 搜索机器人(search:bot)
...
名称 | 类型 | 必填 | 描述
---|---|---|---
query | string | 否 | query (长度范围：0 ～ 50 字符)<br>**示例值**："会议助手"
filter | bot_search_filter | 否 | filter
chat_ids | string\[\] | 否 | 群聊ID列表，查询指定群聊内的机器人<br>群聊ID获取参考：https://open.larkoffice.com/document/server-docs/group/chat/chat-id-description<br>**示例值**：["oc-7890123456abcdef"]<br>**数据校验规则**：<br>- 长度范围：`0` ～ `100`
has_chatter | boolean | 否 | 是否和机器人聊过天，如果设置true，只返回有聊天的机器人<br>**示例值**：false
...
msg | string | 错误描述
data | \- | \-
items | bot_search_item\[\] | items
id | string | 机器人ID
display_info | string | 包含机器人基本信息的卡片，用户搜索关键词命中的文本片段，使用<h></h>标签包裹标注
meta_data | bot_search_meta | 机器人元信息
tenant_id | string | 租户ID
enable_join_group | boolean | 是否允许加入群聊
chat_id | string | 机器人所属的群聊ID
is_agent | boolean | 是否是智能体
...
HTTP状态码 | 错误码 | 描述 | 排查建议
---|---|---|---
400 | 4001 | invalid param: missing required fields | 请参考接口文档的参数要求，检查并修正请求参数
