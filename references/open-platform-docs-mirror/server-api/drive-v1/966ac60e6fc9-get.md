...
Source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/export_task/get
Markdown source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/export_task/get.md
...
### 请求示例
```bash
curl --location --request GET 'https://open.feishu.cn/open-apis/drive/v1/export_tasks/7143131813848809492?token=[REDACTED]' \
