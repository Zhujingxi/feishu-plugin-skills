...
Source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview
Markdown source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview.md
...
当在界面上点击设置了自定义完成的任务的完成选框时，将跳转到第三方界面或产生提示信息引导用户去往第三方系统。用户在第三方系统完成事项后，第三方系统再通过任务API来设置任务完成状态。
