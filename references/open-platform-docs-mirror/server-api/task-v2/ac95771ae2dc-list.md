...
Source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/task-v2/custom_field/list
Markdown source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/task-v2/custom_field/list.md
...
resource_type | string | 否 | 资源类型，如提供则表示仅查询特定资源下的自定义字段。目前只支持tasklist。<br>**示例值**：tasklist
