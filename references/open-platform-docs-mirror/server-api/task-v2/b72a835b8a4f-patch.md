...
Source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/task-v2/comment/patch
Markdown source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/task-v2/comment/patch.md
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用**<br>开启任一权限即可 | 查看、创建、更新、删除任务评论(task:comment:write)<br>创建、更新任务评论(task:comment:writeonly)
...
content | string | 否 | 要更新的评论内容。如果更新该字段，不允许设为空，最大支持3000个UTF-8字符。<br>**示例值**："举杯邀明月，对影成三人"
