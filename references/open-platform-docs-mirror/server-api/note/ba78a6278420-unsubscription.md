...
Source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/note/unsubscription
Markdown source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/note/unsubscription.md
...
基本 | &nbsp;
---|---
HTTP URL | https://open.feishu.cn/open-apis/vc/v1/notes/unsubscription
HTTP Method | POST
...
名称 | 类型 | 必填 | 描述
---|---|---|---
event_type | string | 否 | 事件类型<br>**可选值有:**<br>- `vc.note.generated_v1`: 纪要生成事件<br>**示例值**："vc.note.generated_v1"
