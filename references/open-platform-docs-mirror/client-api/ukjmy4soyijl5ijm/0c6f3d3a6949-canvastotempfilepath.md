...
Source: https://open.feishu.cn/document/uYjL24iN/ukjMy4SOyIjL5IjM/canvastotempfilepath
Markdown source: https://open.feishu.cn/document/uYjL24iN/ukjMy4SOyIjL5IjM/canvastotempfilepath.md
...
fileType | string | 否 | png | 图片类型。可选值：<br>- `jpg`：JPG 图片格式。<br>- `png`：PNG 图片格式。
