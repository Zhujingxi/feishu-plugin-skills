...
Source: https://open.feishu.cn/document/uYjL24iN/uQzM4YjL0MDO24CNzgjN/isodep/close
Markdown source: https://open.feishu.cn/document/uYjL24iN/uQzM4YjL0MDO24CNzgjN/isodep/close.md
...
isoDep.close({
    ...
    fail(err) {
        console.log(`IsoDep.close fail: ${JSON.stringify(err)}`)
    }
});
```
`success`返回对象示例：
