...
Source: https://open.feishu.cn/document/uYjL24iN/ucDM04yNwQjL3ADN
Markdown source: https://open.feishu.cn/document/uYjL24iN/ucDM04yNwQjL3ADN.md
...
left | number | 否 | 0 | 用户卡片原点（左上角）横坐标。单位：px<br>**注意事项**：**注意**：Android、iOS 端暂不支持该字段。
top | number | 否 | 0 | 用户卡片原点（左上角）纵坐标。单位：px<br>**注意事项**：**注意**：Android、iOS 端暂不支持该字段。
