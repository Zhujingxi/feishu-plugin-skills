...
Source: https://open.feishu.cn/document/uYjL24iN/uczMx4yNzEjL3MTM/gettenantappscopes
Markdown source: https://open.feishu.cn/document/uYjL24iN/uczMx4yNzEjL3MTM/gettenantappscopes.md
...
---|---|---
scopes | scope[] | 权限列表。
&emsp;<br>∟<br>&nbsp;<br>name | string | 权限名称。
&emsp;<br>∟<br>&nbsp;<br>status | number | 授权状态。可能值：<br>- `1`：已授权<br>- `2`：未授权
