...
Source: https://open.feishu.cn/document/uAjLw4CM/ukzMukzMukzM/develop-robots/add-bot-to-external-group
Markdown source: https://open.feishu.cn/document/uAjLw4CM/ukzMukzMukzM/develop-robots/add-bot-to-external-group.md
Generated by scripts/crawl_client_docs.py.
-->
# 机器人支持外部群和外部用户单聊

如果你希望把应用机器人添加到外部群，或者与外部租户的用户进行单聊，则可以为机器人开启对外共享能力。对外共享能力目前仅支持企业自建应用。
**注意事项**：开启对外共享前，需完成以下任一认证：
  - **企业或团队认证**：法人认证、公章授权认证、团队认证 任选其一，详见 [飞书认证介绍](https://www.feishu.cn/hc/zh-CN/articles/360034114413)。
  - **个人实名认证**：适用于飞书个人版用户，或未认证企业的成员，详见 [如何开启个人实名认证](https://open.larkoffice.com/document/develop-robots/add-bot-to-external-group?lang=zh-CN#d98af0c5)。
...
![](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/1d2c14b5270c0386a26a0a7ee5c929d0_XrPc91wlgH.png?height=1578&lazyload=true&maxWidth=500&width=1824)

- 与外部用户单聊。通过自动化流程实现用户可能面临的产品功能反馈、业务进展通知等需要。

![](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/5d48b1a50f42e9fa4c69a1249d5ecd8b_nzUiVTzPa1.png?height=1290&lazyload=true&maxWidth=500&width=1084)
...
4. 在 **版本详情** 页面配置 **对外共享** 能力

若企业未完成认证，对外共享能力为置灰状态，不可使用。企业超管可通过完成个人实名认证或企业认证，使用应用的对外共享能力；企业其他成员可通过完成个人实名认证开启对外共享能力。

![通过认证使用对外共享能力.jpeg](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/b9a9015ee6dbb4f4b3329f284174ed3c_e8PTZLrMKK.jpeg?height=1426&lazyload=true&maxWidth=500&width=2802)

若企业已经完成认证，对外共享能力可以使用。

-  支持配置 **允许机器人被添加到外部群中使用**
	-  支持配置 **允许外部用户与机器人单聊**。用户首次开启单聊时，推荐配置需应用所有者审核。用户发起申请后，应用所有者将在开发者小助手机器人中收到审批消息。

![image.png](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/a362cf1e43f7889eb920e33b14a44418_6CAD2mGGwg.png?height=1634&lazyload=true&maxWidth=500&width=2446)
...
在飞书客户端的外部群聊内添加机器人时，支持添加群自定义机器人和开启对外群聊共享的机器人。
- 如果用户需要将对外群聊共享机器人添加到外部群，则该用户必须在[应用可用范围](https://open.feishu.cn/document/home/introduction-to-scope-and-authorization/availability)内，并且该用户在应用所属企业内而不是跨租户用户。
- 将对外群聊共享机器人添加到外部群的操作，在飞书客户端 V7.19 及以上版本开始支持。
...
### 外部用户与机器人单聊
外部用户开启与机器人单聊能力在飞书客户端 V7.22 及以上版本开始支持，其中iOS端用户申请开启单聊的能力在客户端 V7.68及以上版本开始支持

首次发起单聊时需要根据客户端弹窗提示完成确认，确认后即可与机器人单聊。
...
场景 | 说明
---|---
用户在外部群中点击机器人进行单聊 | -   若应用所有者配置了首次开启单聊无需审核，则用户点击机器人后，在弹窗内点击 **开启单聊**，即可与机器人进行单聊。<br>![image.png](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/3043ad481eed7ccff27ae55ef93df425_mNMyB7289B.png?height=1460&lazyload=true&maxWidth=240&width=1054)<br>-   若应用所有者配置了首次开启单聊需审核，则用户点击机器人后，在弹窗内点击 **申请开启单聊**，并根据提示填写申请理由。<br>![image.png](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/99f4f0dcd9cc2d411359f87b79277c68_nqrptChzr1.png?height=1454&lazyload=true&maxWidth=240&width=1048)<br>审核通过或拒绝会收到飞书助手的通知，点击**去对话** 即可打开与机器人的对话。<br>![image.png](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/41463d9d9d959abb01ce03b564533891_DID2hePDso.png?height=668&lazyload=true&maxWidth=300&width=2120)
用户将机器人分享给其他用户 | 1. 通过分享的 Applink、二维码打开机器人。<br>**分享方式**：<br>- 在飞书客户端内点击机器人头像，在卡片右上角点击 **分享** 按钮即可将机器人分享给他人。<br>![image.png](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/b794f079dc5ffe573b0b476dcc395893_78dbiHQgNc.png?height=692&lazyload=true&maxWidth=350&width=842)<br>- 构建并分享机器人的 Applink，具体操作参见[打开机器人会话](https://open.feishu.cn/document/uAjLw4CM/uYjL24iN/applink-protocol/supported-protocol/open-a-bot)。<br>2. 在弹窗内点击 **申请使用**。<br>![](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/ff3ef8dee7c0352cf0c79456327526ec_c3Nsg58MEx.png?height=394&lazyload=true&maxWidth=350&width=1156)<br>3. 查看应用基本信息、权限以及注意事项，并开启单聊<br>- 若应用所有者配置了首次开启单聊无需审核，则用户确认无误后点击 **开启单聊**，即可与机器人进行单聊。<br>![image.png](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/b906f45280ee61aa8ef07ff91a57255b_3gFGDNek1z.png?height=932&lazyload=true&maxWidth=350&width=1190)<br>- 若应用所有者配置了首次开启单聊需审核，则用户填写申请理由，确认无误后点击 **提交**。<br>![image.png](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/8025211a62ef0343c6fe60a7522b81e4_84Qp0r3GHy.png?height=1344&lazyload=true&maxWidth=350&width=1748)<br>审核通过或拒绝会收到飞书助手的通知，点击**去对话** 即可打开与机器人的对话。<br>![image.png](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/41463d9d9d959abb01ce03b564533891_DID2hePDso.png?height=668&lazyload=true&maxWidth=300&width=2120)

当外部用户主动与机器人单聊，并完成确认后，此时机器人可对该外部用户进行以下操作：
...
- 对外共享机器人[将用户拉入外部群聊](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-members/create)。
...
### 应用已开启外部用户单聊开关，仍报错 `Bot has NO availability to this user` 无法发送单聊消息？

该错误码复用覆盖两种业务场景：
- 未开启外部用户与机器人单聊开关
- 已开启开关但外部用户未主动发起与机器人的单聊会话

即便已开启外部用户与机器人单聊开关并配置首次免审，机器人仍不支持主动发起单聊，需外部用户先主动与应用建立单聊会话链路后，机器人方可正常推送消息。
...
1. 进入 [飞书开发者后台](https://open.larkoffice.com/app) 的 **版本管理与发布** 页面，点击 **创建版本**。

2. 在 **对外共享** 区域，将鼠标移动到 **允许机器人被添加到外部群中使用** 选项，会弹出认证要求。

![image.png](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/dbc827c34e6bfa179c55cda691bacf83_M2CNwIqIOI.png?height=1164&lazyload=true&maxWidth=450&width=2132)

3. 点击 **个人实名认证**，弹窗会弹出二维码，使用弹窗提示的飞书账号进行手机扫码。

![image.png](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/59cd22f335f4d1f16b1879c456ba01e6_0RMXYBepAp.png?height=1196&lazyload=true&maxWidth=450&width=2254)

4. 通过手机扫码后，用户可选择「人脸认证」或「银行卡卡号认证」。

4. 认证完成后，即可使用自建应用的对外共享能力。
