...
Source: https://open.feishu.cn/document/uYjL24iN/uUzM4YjL1MDO24SNzgjN/nfcadapter_getndef
Markdown source: https://open.feishu.cn/document/uYjL24iN/uUzM4YjL1MDO24SNzgjN/nfcadapter_getndef.md
Generated by scripts/crawl_client_docs.py.
-->
# NFCAdapter.getNdef()

获取Ndef实例，实例支持NDEF标签的读写
**注意事项**：如果扫描到NdefFormatable类型的标签
