...
Source: https://open.feishu.cn/document/uYjL24iN/uIjNx4iM2EjLyYTM/set-screen-brightness
Markdown source: https://open.feishu.cn/document/uYjL24iN/uIjNx4iM2EjLyYTM/set-screen-brightness.md
...
名称 | 数据类型 | 是否必填 | 默认值 | 描述
---|---|---|---|---
value | number | 是 | \- | 屏幕亮度值。取值范围：0 ~ 1。其中，`0` 最暗、`1` 最亮。<br>在Harmony端支持传入特殊值 `-1`，表示屏幕亮度跟随系统变化。<br>示例值：`0.8`
