...
Source: https://open.feishu.cn/document/uYjL24iN/ucTOz4yN5MjL3kzM
Markdown source: https://open.feishu.cn/document/uYjL24iN/ucTOz4yN5MjL3kzM.md
Generated by scripts/crawl_client_docs.py.
-->
# redirectTo(Object object)

关闭当前页面，跳转到指定页面
**注意事项**：**不能**跳转到 TabBar 页面。
