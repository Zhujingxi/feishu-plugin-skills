...
Source: https://open.feishu.cn/document/uAjLw4CM/uYjL24iN/base-extensions/base-view-extensions/api/table/table_addrecords
Markdown source: https://open.feishu.cn/document/uAjLw4CM/uYjL24iN/base-extensions/base-view-extensions/api/table/table_addrecords.md
...
名称 | 数据类型 | 是否必填 | 描述
---|---|---|---
recordValueList | {<br>&nbsp;&nbsp;fields: {<br>&nbsp;&nbsp;&nbsp;&nbsp;[fieldId: string]: [IOpenCellValue]([IOpenCellValue](https://open.feishu.cn/document/uAjLw4CM/uYjL24iN/base-extensions/base-view-extensions/data-type/iopencellvalue));<br>&nbsp;&nbsp;};<br>}[] | 是 | 需要新增的记录
