...
Source: https://open.feishu.cn/document/uYjL24iN/ugDM04COwQjL4ADN/offchatbadgechange
Markdown source: https://open.feishu.cn/document/uYjL24iN/ugDM04COwQjL4ADN/offchatbadgechange.md
...
onChange | function | 否 | &nbsp; | 回调函数<br>**注意事项**：如果不传 `onChange` 回调函数，则会取消[openChatId](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-id-description)对应的所有监听，传onChange则会取消指定监听
