...
Source: https://open.feishu.cn/document/uYjL24iN/uEDO3UjLxgzN14SM4cTN/setwindowsize
Markdown source: https://open.feishu.cn/document/uYjL24iN/uEDO3UjLxgzN14SM4cTN/setwindowsize.md
Generated by scripts/crawl_client_docs.py.
-->
# setWindowSize(Object object)

小程序在 window 和 window-semi 模式下调整独立窗口的大小和位置
**注意事项**：无论是否有外接屏幕，x、y 都是基于飞书所在屏幕定位，当飞书和小程序不在一个屏幕时，设置 x、y 中的任意一个属性都会使小程序跳到飞书所在屏幕上
