...
Source: https://open.feishu.cn/document/uYjL24iN/uMTOuMTOuMTO/getlocationstatus
Markdown source: https://open.feishu.cn/document/uYjL24iN/uMTOuMTOuMTO/getlocationstatus.md
...
名称 | 数据类型 | 描述
---|---|---
gpsStatus | string | GPS开关状态。可能值：<br>- `on`：打开<br>- `off`：关闭
