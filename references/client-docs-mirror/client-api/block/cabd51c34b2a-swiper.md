...
Source: https://open.feishu.cn/document/uAjLw4CM/uYjL24iN/block/component/container-component/swiper
Markdown source: https://open.feishu.cn/document/uAjLw4CM/uYjL24iN/block/component/container-component/swiper.md
...
名称 | 数据类型 | 必填 | 默认值 | 说明
---|---|---|---|---
indicator-dots | boolean | 否 | - iOS/Android: true<br>- PC: false | 是否显示面板指示点<br>**注意事项**：由于历史版本原因默认值不一致，建议开发者手动设置此属性保持表现一致。
indicator-color | string | 否 | rgba(0,0,0,.3) | 指示点颜色<br>**注意事项**：建议使用 rgba 方式设置颜色，hex color 暂不支持。
indicator-active-color | string | 否 | rgba(0,0,0,0) | 当前选中的指示点颜色<br>**注意事项**：建议使用 rgba 方式设置颜色，hex color 暂不支持。
autoplay | boolean | 否 | - iOS<br>- < V6.1: true<br>- \>= V6.1: false<br>- Android: true<br>- PC: false | 是否自动切换<br>**注意事项**：由于历史版本原因默认值不一致，建议开发者手动设置此属性保持表现一致。
