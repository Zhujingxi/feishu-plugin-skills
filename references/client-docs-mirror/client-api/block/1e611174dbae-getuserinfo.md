...
Source: https://open.feishu.cn/document/uAjLw4CM/uYjL24iN/block/api/user/getuserinfo
Markdown source: https://open.feishu.cn/document/uAjLw4CM/uYjL24iN/block/api/user/getuserinfo.md
Generated by scripts/crawl_client_docs.py.
-->
# getUserInfo

获取已登录用户的基本信息或特殊信息。
**注意事项**：调用前确保已经调用 tt.login 接口成功登录。
...
&emsp;<br>∟<br>&nbsp;<br>gender | string | 用户性别<br>**可选值**：<br>- `''`：未知<br>- `male`：男性<br>- `female`：女性
&emsp;<br>∟<br>&nbsp;<br>country | string | 用户所在国家或地区
&emsp;<br>∟<br>&nbsp;<br>province | string | 用户所在省份<br>**注意事项**：该字段已下线
&emsp;<br>∟<br>&nbsp;<br>city | string | 用户所在城市
&emsp;<br>∟<br>&nbsp;<br>language | string | 所在地区所用的语言<br>**可选值**：<br>- `en_US`：英文<br>- `zh_CN`：中文
