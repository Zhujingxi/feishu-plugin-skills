...
Source: https://open.feishu.cn/document/uYjL24iN/uIjNwEjLyYDMx4iM2ATM/grantscreenshot
Markdown source: https://open.feishu.cn/document/uYjL24iN/uIjNwEjLyYDMx4iM2ATM/grantscreenshot.md
...
名称 | 数据类型 | 是否必填 | 默认值 | 描述
---|---|---|---|---
status | number | 是 | 0 | 开启/禁用截屏。可选值：：<br>- `0`：禁用截屏。<br>- `1`：开启截屏。
