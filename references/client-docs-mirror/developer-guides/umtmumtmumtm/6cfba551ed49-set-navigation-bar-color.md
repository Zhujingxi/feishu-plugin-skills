...
Source: https://open.feishu.cn/document/uYjL24iN/uMTMuMTMuMTM/web-app-open-ability/set-navigation-bar-color
Markdown source: https://open.feishu.cn/document/uYjL24iN/uMTMuMTMuMTM/web-app-open-ability/set-navigation-bar-color.md
